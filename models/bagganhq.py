import models.gan_util as net_util

from lib.util.visualization import *

from models.base_model import *
from models.models import StyleGANDiscriminator, StyleGANGenerator
...
class BagGANHQ(GANBaseModel):
    ...
    All options are specified using the configs object whose attributes provide
    the values. The configs object can be loaded as a module or can be an
    argument parser. The options in configs will be described as they are used
