...
from models.blocks import PixelNorm, EqualizedLinearBlock
from models.blocks import ConstantInputBlock, ConvLayerWithStyleMod, \
                                 SynthesisBlock,     XToImageConverter
from models.blocks import DiscConvBlock, ResidualBlock
...
class StyleGANGenerator(nn.Module):
    ...
    def mean_latent(self, n_latent=1000):
    ...
    def forward(self,
        ...
        if noise is None:
            if randomize_noise:
                ...
                noise = [
                    getattr(self.noise_blks, f"noise_{i}")
